...
class Class3 : public Class1 { int data3; };

class Class5 : public Class1, public Class3 { int data5; };
class Class4 : public Class5, public Class2, public Class1 { int data4; };
class Class6 : public Class3 { int data6; };
class Class7 : public Class4, public Class6 { int data7; };

class VirtualClass1 { int data1; };
class VirtualClass2 : virtual public VirtualClass1 { int data2; };
class VirtualClass3 : virtual public VirtualClass1 { int data3; };

class VirtualClass5 : virtual public VirtualClass1, virtual public VirtualClass3 { int data5; };
class VirtualClass4 : virtual public VirtualClass5, virtual public VirtualClass2, virtual public VirtualClass1 { int data4; };
class VirtualClass6 : virtual public VirtualClass3 { int data6; };
